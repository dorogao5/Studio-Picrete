    ...
    *,
    ...
    if generation_policy == "single_verifier" and prompt_context["blueprint_contract"]:
        verifier_prompt += (
            ...
            "Проверьте также объяснения: не называйте определения приближениями и не обосновывайте "
            "точные связи ненужным условием малости. Общие этапы из инструкции блюпринта нужны "
            "лишь когда применимы к опорному примеру, не расширяйте ими задание. "
